...
/* harmony import */ var _audit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./audit */ 177);
/* harmony import */ var _observable_timer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../observable/timer */ 1356);
...
/* harmony export */ });
/* harmony import */ var _util_Immediate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/Immediate */ 1180);
/* harmony import */ var _AsyncAction__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AsyncAction */ 2530);
...
/* harmony export */ });
/* harmony import */ var _AsapAction__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AsapAction */ 257);
/* harmony import */ var _AsapScheduler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AsapScheduler */ 9046);
...
/* harmony export */ });
/* harmony import */ var _isArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./isArray */ 9845);
...
/* harmony import */ var _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/cdk/scrolling */ 9691);
...
/* harmony import */ var _D_Development_Ionic_saphsVideos_node_modules_ngtools_webpack_src_loaders_direct_resource_js_home_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./home.page.html */ 2056);
...
/* harmony import */ var _awesome_cordova_plugins_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @awesome-cordova-plugins/speech-recognition/ngx */ 4811);
/* harmony import */ var _awesome_cordova_plugins_screen_orientation_ngx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @awesome-cordova-plugins/screen-orientation/ngx */ 4553);
/* harmony import */ var _youtube_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../youtube.service */ 7195);
...
let HomePage = class HomePage {
    constructor(router, youTubeService, speechRecognition, screenOrientation) {
        this.router = router;
        this.youTubeService = youTubeService;
        this.speechRecognition = speechRecognition;
        this.screenOrientation = screenOrientation;
        this.pageNo = 0;
        this.itemsToDisplay = 20;
    ...
    ionViewWillEnter() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.resetDisplay();
            this.saphdata = yield this.youTubeService.getFirstVideos();
            this.filteredSaphdata = Object.assign([], this.saphdata);
            this.loadData("");
            this.remainingSaphdata = yield this.youTubeService.getRemainingVideos();
    ...
    filterVideos() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__awaiter)(this, void 0, void 0, function* () {
            this.searchString = yield this.speechRecognition.startListening({ prompt: "Filter By Title", showPopup: true }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.take)(1)).toPromise();
            this.filteredSaphdata = yield this.youTubeService.filterVideos(this.searchString[0]);
            this.resetDisplay();
            this.loadData("");
...
HomePage.ctorParameters = () => [
    ...
    { type: _youtube_service__WEBPACK_IMPORTED_MODULE_4__.YoutubeService },
    { type: _awesome_cordova_plugins_speech_recognition_ngx__WEBPACK_IMPORTED_MODULE_2__.SpeechRecognition },
...
HomePage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-home',
        template: _D_Development_Ionic_saphsVideos_node_modules_ngtools_webpack_src_loaders_direct_resource_js_home_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ 9457);
...
let YoutubeService = class YoutubeService {
    constructor(http) {
        this.http = http;
        this.apiKey = "AIzaSyBr85GK67KCTN92VT1rTPZ2W8UzuD93RAE";
        this.playlistId = "UUrbrN66-0KK6DaLJg2t5fvQ";
        this.part = "snippet,contentDetails";
        this.statistics = "statistics";
        this.maxResults = "50";
        this.playlistItemsUrl = "https://www.googleapis.com/youtube/v3/playlistItems";
        this.videoStatisticsUrl = "https://www.googleapis.com/youtube/v3/videos";
        this.videoList = [];
        this.remainingVideoList = [];
    }
    getFirstVideos() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            this.data = yield this.http.get(this.playlistItemsUrl + "?key=" + this.apiKey + "&playlistId=" + this.playlistId +
            ...
            let stats = yield (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.forkJoin)([getFirstList]).toPromise();
    ...
    getRemainingVideos() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            ...
            let stats = yield (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.forkJoin)([getFirstList, getSecondList, getThirdList, getFourthList]).toPromise();
            this.myStatistics = stats[0];
            this.mydata = this.myStatistics.items;
    ...
    filterVideos(searchString) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            if (searchString.toLowerCase() === "reset") {
                return yield this.videoList;
            }
            else {
                return yield this.videoList.filter(video => video.snippet.title.toLowerCase().indexOf(searchString.toLowerCase()) !== -1);
            }
        });
    }
...
YoutubeService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
module.exports = "ion-title {\n  background: #109761;\n  color: blue;\n  font-size: 24px;\n}\n\nion-toolbar {\n  --background: rgb(16, 151, 97);\n}\n\nion-buttons {\n  background: #109761;\n}\n\nion-searchbar {\n  --background: rgb(197, 212, 206);\n  --border-radius: 12px;\n  color: black;\n}\n\nion-card {\n  --background: rgb(132, 168, 209);\n  border-radius: 12px;\n}\n\nion-item {\n  --background: rgb(130, 143, 151);\n}\n\nimg {\n  margin-bottom: 7px;\n}\n\n.views {\n  background: #0a0c81;\n  color: #f8fcfb;\n}\n\n.likes {\n  background: #ec0808;\n  color: #f8fcfb;\n}\n\n.uploaded {\n  background: #0c8039;\n  color: #f8fcfb;\n}\n\n.common {\n  margin-bottom: 7px;\n  font-size: 12px;\n  border-radius: 12px;\n  min-width: 10px;\n  padding: 4px;\n  text-align: center;\n}\n\n.spinner-container {\n  width: 100%;\n  text-align: center;\n  padding: 10px;\n}\n\ncdk-virtual-scroll-viewport {\n  height: 100vh;\n}\n\ncdk-virtual-scroll-viewport ion-item {\n  height: 520px;\n}\n\n.icon-colour {\n  color: #cc243a;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
...
/* harmony export */ });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ 6952);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! rxjs */ 919);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! rxjs */ 981);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! rxjs */ 6511);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! rxjs */ 6952);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ 8785);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ 4907);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! rxjs/operators */ 4286);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! rxjs/operators */ 9026);
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! rxjs/operators */ 8537);
...
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @angular/cdk/collections */ 8288);
